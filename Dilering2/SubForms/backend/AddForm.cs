...
namespace tposDesktop
{
    public partial class AddForm : DesignedForm
    {
        ...
        public AddForm(DataSetTpos.productRow productRow)
        {
            ...
            if (productRow.measureId == 3)
            {
                measureRadio3.Checked = true;
                tbxMheight.Visible = true;
                tbxMwidth.Visible = true;
                lblX.Visible = true;
                string parm = productRow.extParam;
                tbxMwidth.Text = parm.Split(new char[] { 'x' })[0];
                tbxMheight.Text = parm.Split(new char[] { 'x' })[1];
            }
            ...
            tbxRozPrice.Text = productRow.priceRozn.ToString();
        ...
        private void measureRadio_checkedChanged(object sender, EventArgs e)
        {
            bool is_m2 = measureRadio3.Checked;


            tbxMwidth.Visible = is_m2;
            tbxMheight.Visible = is_m2;
            lblX.Visible = is_m2;
