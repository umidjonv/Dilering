...
namespace Classes.DB
{
    ...
    public class UpdateThreading
    {
        ...
        public UpdateThreading()
        {
            ...
            if (!(ordersTable.Columns["measureID"] is DataColumn))
                ordersTable.Columns.Add("measureID", typeof(int));
            if (!(ordersTable.Columns["extParam"] is DataColumn))
            {
                ordersTable.Columns.Add("extParam", typeof(string));
                ordersTable.Columns.Add("extParamValue", typeof(string));
            }
            string s ="";
